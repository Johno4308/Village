...
var renderer = new THREE.WebGLRenderer({
  // declaring the webgl renderer class into a variable renderer
...
function startRotation(step) {
  ...
  if (
    ...
    window.height !== window.clientHeight
  ) {
...
var shapeRotationDirectionControl =
  document.getElementById("direction-control");
...
var shapeRotationStepValueText = document.getElementById(
  "rotation-step-value-text"
);
...
shapeRotationDirectionControl.addEventListener("click", function (e) {
  ...
  else e.target.className = "clockwise";
...
shapeRotationMotionControl.addEventListener("click", function (e) {
  if (shapeIsRotating) e.target.className = "start";
  else e.target.className = "stop";
